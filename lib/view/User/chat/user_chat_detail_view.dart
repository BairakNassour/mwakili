...
class UserChatDetailView extends StatefulWidget {
  final String clientName; 
  final bool isOnline;
  final int lawyerId; 

  const UserChatDetailView({
    Key? key,
  ...
  @override
  State<UserChatDetailView> createState() => _UserChatDetailViewState();
}

class _UserChatDetailViewState extends State<UserChatDetailView> {
  ...
  Future<void> _fetchChatMessages() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/chats/${widget.lawyerId}?receiver_type=lawyer'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        _showSnackBar("فشل في تحميل المحادثة القانونية");
      }
    } catch (e) {
      ...
      child: Row(
        children: [
          ...
          CircleAvatar(
            ...
            child: Text(
              widget.clientName.isNotEmpty ? widget.clientName.substring(0, 1) : "م",
